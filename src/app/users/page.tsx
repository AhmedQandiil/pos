  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <h1 className="text-2xl md:text-3xl font-black">إدارة المستخدمين</h1>
        <button
          onClick={handleAdd}
          className="flex items-center justify-center gap-3 bg-[#f59e0b] hover:bg-[#d97706] text-black font-black py-4 md:py-3 px-8 rounded-2xl transition-all shadow-lg shadow-amber-500/20 active:scale-95 text-lg md:text-base"
        >
      ...
      <div className="md:hidden space-y-4">
        {users.map((user) => (
          <div 
            key={user.id} 
            onClick={() => handleEdit(user)}
            className="bg-[#1a1d26] border border-white/5 rounded-3xl p-5 space-y-4 active:scale-[0.98] transition-all"
          >
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 font-space-mono font-bold tracking-widest">PIN: {user.pin}</p>
                </div>
              </div>
              <div className="text-left">
                <Edit2 className="w-6 h-6 text-blue-400 opacity-50" />
              </div>
            </div>
